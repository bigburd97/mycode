...
def battle(name, player_health, monster_health, freeze_potion, heals_remaining):
    ...
    while player_health > 0 and monster_health > 0:
        ...
        if action == 'attack':
            ...
            if freeze_potion > 0:
                monster_frozen = random.random() > 0.4  # 40% chance to freeze the monster
                if monster_frozen:
                    print("You use a freeze potion to freeze the monster!")
                else:
                    print("Your freeze potion missed!")
                freeze_potion -= 1
            else:
                print("You don't have any freeze potions left!")
